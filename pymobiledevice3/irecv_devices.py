...
IRECV_DEVICES: tuple[IRecvDevice, ...] = (
    ...
    IRecvDevice(
        product_type="iPhone9,2",
        hardware_model="d11ap",
        board_id=0x0A,
        chip_id=0x8010,
    ...
    IRecvDevice(
        ...
        hardware_model="d20ap",
        board_id=0x02,
        chip_id=0x8015,
        display_name="iPhone 8 (Global)",
    ),
    IRecvDevice(
        product_type="iPhone10,2",
    ...
    IRecvDevice(
        ...
        hardware_model="n102ap",
        board_id=0x10,
        chip_id=0x7000,
        display_name="iPod Touch (6th gen)",
    ),
    IRecvDevice(
        product_type="iPod9,1",
        hardware_model="n112ap",
        board_id=0x16,
        chip_id=0x8010,
    ...
    IRecvDevice(
        ...
        hardware_model="j2aap",
        board_id=0x04,
        chip_id=0x8945,
        display_name="iPad (3rd gen, GSM)",
    ),
    IRecvDevice(
        product_type="iPad3,4",
        hardware_model="p101ap",
        board_id=0x00,
        chip_id=0x8955,
    ...
    IRecvDevice(
        ...
        hardware_model="j86ap",
        board_id=0x0C,
        chip_id=0x8960,
        display_name="iPad mini 2 (Cellular)",
    ),
    IRecvDevice(
        product_type="iPad4,6",
        hardware_model="j87ap",
        board_id=0x0E,
        chip_id=0x8960,
        display_name="iPad mini 2 (China)",
    ),
    IRecvDevice(
        product_type="iPad4,7",
        hardware_model="j85map",
        board_id=0x32,
        chip_id=0x8960,
        display_name="iPad mini 3 (WiFi)",
    ),
    IRecvDevice(
        product_type="iPad4,8",
        hardware_model="j86map",
        board_id=0x34,
        chip_id=0x8960,
        display_name="iPad mini 3 (Cellular)",
    ),
    IRecvDevice(
        product_type="iPad4,9",
        hardware_model="j87map",
        board_id=0x36,
        chip_id=0x8960,
    ...
    IRecvDevice(
        ...
        hardware_model="j82ap",
        board_id=0x02,
        chip_id=0x7001,
        display_name="iPad Air 2 (Cellular)",
    ),
    IRecvDevice(
        product_type="iPad6,3",
        hardware_model="j127ap",
        board_id=0x08,
        chip_id=0x8001,
        display_name="iPad Pro 9.7-inch (WiFi)",
    ),
    IRecvDevice(
        product_type="iPad6,4",
        hardware_model="j128ap",
        board_id=0x0A,
        chip_id=0x8001,
        display_name="iPad Pro 9.7-inch (Cellular)",
    ),
    IRecvDevice(
        product_type="iPad6,7",
        hardware_model="j98aap",
        board_id=0x10,
        chip_id=0x8001,
        display_name="iPad Pro 12.9-inch (1st gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad6,8",
        hardware_model="j99aap",
        board_id=0x12,
        chip_id=0x8001,
    ...
    IRecvDevice(
        product_type="iPad6,11",
        hardware_model="j71tap",
        board_id=0x10,
        chip_id=0x8003,
        display_name="iPad (5th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad6,12",
        hardware_model="j72sap",
        board_id=0x12,
        chip_id=0x8000,
    ...
    IRecvDevice(
        product_type="iPad6,12",
        hardware_model="j72tap",
        board_id=0x12,
        chip_id=0x8003,
        display_name="iPad (5th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad7,1",
        hardware_model="j120ap",
        board_id=0x0C,
        chip_id=0x8011,
        display_name="iPad Pro 12.9-inch (2nd gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad7,2",
        hardware_model="j121ap",
        board_id=0x0E,
        chip_id=0x8011,
        display_name="iPad Pro 12.9-inch (2nd gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad7,3",
        hardware_model="j207ap",
        board_id=0x04,
        chip_id=0x8011,
        display_name="iPad Pro 10.5-inch (WiFi)",
    ),
    IRecvDevice(
        product_type="iPad7,4",
        hardware_model="j208ap",
        board_id=0x06,
        chip_id=0x8011,
        display_name="iPad Pro 10.5-inch (Cellular)",
    ),
    IRecvDevice(
        product_type="iPad7,5",
        hardware_model="j71bap",
        board_id=0x18,
        chip_id=0x8010,
        display_name="iPad (6th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad7,6",
        hardware_model="j72bap",
        board_id=0x1A,
        chip_id=0x8010,
        display_name="iPad (6th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad7,11",
        hardware_model="j171ap",
        board_id=0x1C,
        chip_id=0x8010,
        display_name="iPad (7th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad7,12",
        hardware_model="j172ap",
        board_id=0x1E,
        chip_id=0x8010,
    ...
    IRecvDevice(
        ...
        hardware_model="j317ap",
        board_id=0x0C,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (1st gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad8,2",
        hardware_model="j317xap",
        board_id=0x1C,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (1st gen, WiFi, 1TB)",
    ),
    IRecvDevice(
        product_type="iPad8,3",
        hardware_model="j318ap",
        board_id=0x0E,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (1st gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad8,4",
        hardware_model="j318xap",
        board_id=0x1E,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (1st gen, Cellular, 1TB)",
    ),
    IRecvDevice(
        product_type="iPad8,5",
        hardware_model="j320ap",
        board_id=0x08,
        chip_id=0x8027,
        display_name="iPad Pro 12.9-inch (3rd gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad8,6",
        hardware_model="j320xap",
        board_id=0x18,
        chip_id=0x8027,
    ...
    IRecvDevice(
        ...
        hardware_model="j321ap",
        board_id=0x0A,
        chip_id=0x8027,
        display_name="iPad Pro 12.9-inch (3rd gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad8,8",
        hardware_model="j321xap",
        board_id=0x1A,
        chip_id=0x8027,
    ...
    IRecvDevice(
        ...
        hardware_model="j417ap",
        board_id=0x3C,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (2nd gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad8,10",
        hardware_model="j418ap",
        board_id=0x3E,
        chip_id=0x8027,
        display_name="iPad Pro 11-inch (2nd gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad8,11",
        hardware_model="j420ap",
        board_id=0x38,
        chip_id=0x8027,
        display_name="iPad Pro 12.9-inch (4th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad8,12",
        hardware_model="j421ap",
        board_id=0x3A,
        chip_id=0x8027,
        display_name="iPad Pro 12.9-inch (4th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad11,1",
        hardware_model="j210ap",
        board_id=0x14,
        chip_id=0x8020,
        display_name="iPad mini (5th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad11,2",
        hardware_model="j211ap",
        board_id=0x16,
        chip_id=0x8020,
        display_name="iPad mini (5th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad11,3",
        hardware_model="j217ap",
        board_id=0x1C,
        chip_id=0x8020,
        display_name="iPad Air (3rd gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad11,4",
    ...
    IRecvDevice(
        ...
        hardware_model="j171aap",
        board_id=0x24,
        chip_id=0x8020,
        display_name="iPad (8th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad11,7",
        hardware_model="j172aap",
        board_id=0x26,
        chip_id=0x8020,
        display_name="iPad (8th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad12,1",
        hardware_model="j181ap",
        board_id=0x18,
        chip_id=0x8030,
        display_name="iPad (9th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad12,2",
        hardware_model="j182ap",
        board_id=0x1A,
        chip_id=0x8030,
        display_name="iPad (9th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad13,1",
        hardware_model="j307ap",
        board_id=0x04,
        chip_id=0x8101,
        display_name="iPad Air (4th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad13,2",
    ...
    IRecvDevice(
        ...
        hardware_model="j517ap",
        board_id=0x08,
        chip_id=0x8103,
        display_name="iPad Pro 11-inch (3rd gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad13,5",
        hardware_model="j517xap",
        board_id=0x0A,
        chip_id=0x8103,
        display_name="iPad Pro 11-inch (3rd gen, WiFi, 2TB)",
    ),
    IRecvDevice(
        product_type="iPad13,6",
        hardware_model="j518ap",
        board_id=0x0C,
        chip_id=0x8103,
        display_name="iPad Pro 11-inch (3rd gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad13,7",
        hardware_model="j518xap",
        board_id=0x0E,
        chip_id=0x8103,
    ...
    IRecvDevice(
        ...
        hardware_model="j310ap",
        board_id=0x04,
        chip_id=0x8110,
        display_name="iPad mini (6th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad14,2",
        hardware_model="j311ap",
        board_id=0x06,
        chip_id=0x8110,
    ...
    IRecvDevice(
        ...
        hardware_model="j617ap",
        board_id=0x08,
        chip_id=0x8112,
        display_name="iPad Pro 11-inch (4th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad14,4",
        hardware_model="j618ap",
        board_id=0x0A,
        chip_id=0x8112,
        display_name="iPad Pro 11-inch (4th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad14,5",
        hardware_model="j620ap",
        board_id=0x0C,
        chip_id=0x8112,
        display_name="iPad Pro 12.9-inch (6th gen, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad14,6",
        hardware_model="j621ap",
        board_id=0x0E,
        chip_id=0x8112,
        display_name="iPad Pro 12.9-inch (6th gen, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad14,8",
        hardware_model="j507ap",
        board_id=0x10,
        chip_id=0x8112,
        display_name="iPad Air 11-inch (M2, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad14,9",
    ...
    IRecvDevice(
        ...
        hardware_model="j537ap",
        board_id=0x14,
        chip_id=0x8112,
        display_name="iPad Air 13-inch (M2, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad14,11",
    ...
    IRecvDevice(
        ...
        hardware_model="j607ap",
        board_id=0x08,
        chip_id=0x8122,
        display_name="iPad Air 11-inch (M3, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad15,4",
    ...
    IRecvDevice(
        ...
        hardware_model="j637ap",
        board_id=0x0C,
        chip_id=0x8122,
        display_name="iPad Air 13-inch (M3, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad15,6",
    ...
    IRecvDevice(
        ...
        hardware_model="j481ap",
        board_id=0x10,
        chip_id=0x8120,
        display_name="iPad (A16, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad15,8",
    ...
    IRecvDevice(
        ...
        hardware_model="j410ap",
        board_id=0x08,
        chip_id=0x8130,
        display_name="iPad mini (A17 Pro, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad16,2",
    ...
    IRecvDevice(
        ...
        hardware_model="j717ap",
        board_id=0x08,
        chip_id=0x8132,
        display_name="iPad Pro 11-inch (M4, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad16,4",
        hardware_model="j718ap",
        board_id=0x0A,
        chip_id=0x8132,
        display_name="iPad Pro 11-inch (M4, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad16,5",
        hardware_model="j720ap",
        board_id=0x0C,
        chip_id=0x8132,
        display_name="iPad Pro 13-inch (M4, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad16,6",
        hardware_model="j721ap",
        board_id=0x0E,
        chip_id=0x8132,
        display_name="iPad Pro 13-inch (M4, Cellular)",
    ),
    IRecvDevice(
        product_type="iPad16,8",
        hardware_model="j707ap",
        board_id=0x10,
        chip_id=0x8132,
        display_name="iPad Air 11-inch (M4, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad16,9",
    ...
    IRecvDevice(
        ...
        hardware_model="j737ap",
        board_id=0x14,
        chip_id=0x8132,
        display_name="iPad Air 13-inch (M4, WiFi)",
    ),
    IRecvDevice(
        product_type="iPad16,11",
    ...
    # HomePod
    IRecvDevice(
        product_type="AudioAccessory1,1",
    ...
    # Apple Watch
    IRecvDevice(
        product_type="Watch1,1",
        hardware_model="n27aap",
        board_id=0x02,
        chip_id=0x7002,
        display_name="Apple Watch 38mm (1st gen)",
    ),
    IRecvDevice(
        product_type="Watch1,2",
        hardware_model="n28aap",
        board_id=0x04,
        chip_id=0x7002,
        display_name="Apple Watch 42mm (1st gen)",
    ),
    IRecvDevice(
        product_type="Watch2,6",
        hardware_model="n27dap",
        board_id=0x02,
        chip_id=0x8002,
        display_name="Apple Watch Series 1 (38mm)",
    ),
    IRecvDevice(
        product_type="Watch2,7",
        hardware_model="n28dap",
        board_id=0x04,
        chip_id=0x8002,
        display_name="Apple Watch Series 1 (42mm)",
    ),
    IRecvDevice(
        product_type="Watch2,3",
        hardware_model="n74ap",
        board_id=0x0C,
        chip_id=0x8002,
        display_name="Apple Watch Series 2 (38mm)",
    ),
    IRecvDevice(
        product_type="Watch2,4",
        hardware_model="n75ap",
        board_id=0x0E,
        chip_id=0x8002,
        display_name="Apple Watch Series 2 (42mm)",
    ),
    IRecvDevice(
        product_type="Watch3,1",
        hardware_model="n111sap",
        board_id=0x1C,
        chip_id=0x8004,
        display_name="Apple Watch Series 3 (38mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch3,2",
        hardware_model="n111bap",
        board_id=0x1E,
        chip_id=0x8004,
        display_name="Apple Watch Series 3 (42mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch3,3",
        hardware_model="n121sap",
        board_id=0x18,
        chip_id=0x8004,
        display_name="Apple Watch Series 3 (38mm)",
    ),
    IRecvDevice(
        product_type="Watch3,4",
        hardware_model="n121bap",
        board_id=0x1A,
        chip_id=0x8004,
        display_name="Apple Watch Series 3 (42mm)",
    ),
    IRecvDevice(
        product_type="Watch4,1",
        hardware_model="n131sap",
        board_id=0x08,
        chip_id=0x8006,
        display_name="Apple Watch Series 4 (40mm)",
    ),
    IRecvDevice(
        product_type="Watch4,2",
        hardware_model="n131bap",
        board_id=0x0A,
        chip_id=0x8006,
        display_name="Apple Watch Series 4 (44mm)",
    ),
    IRecvDevice(
        product_type="Watch4,3",
        hardware_model="n141sap",
        board_id=0x0C,
        chip_id=0x8006,
        display_name="Apple Watch Series 4 (40mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch4,4",
        hardware_model="n141bap",
        board_id=0x0E,
        chip_id=0x8006,
        display_name="Apple Watch Series 4 (44mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch5,1",
        hardware_model="n144sap",
        board_id=0x10,
        chip_id=0x8006,
        display_name="Apple Watch Series 5 (40mm)",
    ),
    IRecvDevice(
        product_type="Watch5,2",
        hardware_model="n144bap",
        board_id=0x12,
        chip_id=0x8006,
        display_name="Apple Watch Series 5 (44mm)",
    ),
    IRecvDevice(
        product_type="Watch5,3",
        hardware_model="n146sap",
        board_id=0x14,
        chip_id=0x8006,
        display_name="Apple Watch Series 5 (40mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch5,4",
        hardware_model="n146bap",
        board_id=0x16,
        chip_id=0x8006,
        display_name="Apple Watch Series 5 (44mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch5,9",
        hardware_model="n140sap",
        board_id=0x28,
        chip_id=0x8006,
        display_name="Apple Watch SE (40mm)",
    ),
    IRecvDevice(
        product_type="Watch5,10",
        hardware_model="n140bap",
        board_id=0x2A,
        chip_id=0x8006,
        display_name="Apple Watch SE (44mm)",
    ),
    IRecvDevice(
        product_type="Watch5,11",
        hardware_model="n142sap",
        board_id=0x2C,
        chip_id=0x8006,
        display_name="Apple Watch SE (40mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch5,12",
        hardware_model="n142bap",
        board_id=0x2E,
        chip_id=0x8006,
    ...
    IRecvDevice(
        ...
        hardware_model="n157sap",
        board_id=0x08,
        chip_id=0x8301,
        display_name="Apple Watch Series 6 (40mm)",
    ),
    IRecvDevice(
        product_type="Watch6,2",
        hardware_model="n157bap",
        board_id=0x0A,
        chip_id=0x8301,
        display_name="Apple Watch Series 6 (44mm)",
    ),
    IRecvDevice(
        product_type="Watch6,3",
        hardware_model="n158sap",
        board_id=0x0C,
        chip_id=0x8301,
        display_name="Apple Watch Series 6 (40mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch6,4",
        hardware_model="n158bap",
        board_id=0x0E,
        chip_id=0x8301,
        display_name="Apple Watch Series 6 (44mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch6,6",
        hardware_model="n187sap",
        board_id=0x10,
        chip_id=0x8301,
        display_name="Apple Watch Series 7 (41mm)",
    ),
    IRecvDevice(
        product_type="Watch6,7",
        hardware_model="n187bap",
        board_id=0x12,
        chip_id=0x8301,
        display_name="Apple Watch Series 7 (45mm)",
    ),
    IRecvDevice(
        product_type="Watch6,8",
        hardware_model="n188sap",
        board_id=0x14,
        chip_id=0x8301,
        display_name="Apple Watch Series 7 (41mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch6,9",
        hardware_model="n188bap",
        board_id=0x16,
        chip_id=0x8301,
    ...
    IRecvDevice(
        ...
        hardware_model="n197sap",
        board_id=0x30,
        chip_id=0x8301,
        display_name="Apple Watch Series 8 (41mm)",
    ),
    IRecvDevice(
        product_type="Watch6,15",
        hardware_model="n197bap",
        board_id=0x32,
        chip_id=0x8301,
        display_name="Apple Watch Series 8 (45mm)",
    ),
    IRecvDevice(
        product_type="Watch6,16",
        hardware_model="n198sap",
        board_id=0x34,
        chip_id=0x8301,
    ...
    IRecvDevice(
        ...
        hardware_model="n207sap",
        board_id=0x08,
        chip_id=0x8310,
        display_name="Apple Watch Series 9 (41mm)",
    ),
    IRecvDevice(
        product_type="Watch7,2",
        hardware_model="n207bap",
        board_id=0x0A,
        chip_id=0x8310,
        display_name="Apple Watch Series 9 (45mm)",
    ),
    IRecvDevice(
        product_type="Watch7,3",
        hardware_model="n208sap",
        board_id=0x0C,
        chip_id=0x8310,
        display_name="Apple Watch Series 9 (41mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,4",
        hardware_model="n208bap",
        board_id=0x0E,
        chip_id=0x8310,
    ...
    IRecvDevice(
        ...
        hardware_model="n210ap",
        board_id=0x02,
        chip_id=0x8310,
        display_name="Apple Watch Ultra 2",
    ),
    IRecvDevice(
        product_type="Watch7,8",
        hardware_model="n217sap",
        board_id=0x10,
        chip_id=0x8310,
    ...
    IRecvDevice(
        ...
        hardware_model="n217bap",
        board_id=0x12,
        chip_id=0x8310,
        display_name="Apple Watch Series 10 (46mm)",
    ),
    IRecvDevice(
        product_type="Watch7,10",
        hardware_model="n218sap",
        board_id=0x14,
        chip_id=0x8310,
        display_name="Apple Watch Series 10 (42mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,11",
        hardware_model="n218bap",
        board_id=0x16,
        chip_id=0x8310,
        display_name="Apple Watch Series 10 (46mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,12",
        hardware_model="n230ap",
        board_id=0x22,
        chip_id=0x8310,
        display_name="Apple Watch Ultra 3",
    ),
    IRecvDevice(
        product_type="Watch7,13",
        hardware_model="n243sap",
        board_id=0x28,
        chip_id=0x8310,
        display_name="Apple Watch SE 3 (40mm)",
    ),
    IRecvDevice(
        product_type="Watch7,14",
        hardware_model="n243bap",
        board_id=0x2A,
        chip_id=0x8310,
        display_name="Apple Watch SE 3 (44mm)",
    ),
    IRecvDevice(
        product_type="Watch7,15",
        hardware_model="n244sap",
        board_id=0x2C,
        chip_id=0x8310,
        display_name="Apple Watch SE 3 (40mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,16",
        hardware_model="n244bap",
        board_id=0x2E,
        chip_id=0x8310,
        display_name="Apple Watch SE 3 (44mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,17",
        hardware_model="n227sap",
        board_id=0x18,
        chip_id=0x8310,
        display_name="Apple Watch Series 11 (42mm)",
    ),
    IRecvDevice(
        product_type="Watch7,18",
        hardware_model="n227bap",
        board_id=0x1A,
        chip_id=0x8310,
        display_name="Apple Watch Series 11 (46mm)",
    ),
    IRecvDevice(
        product_type="Watch7,19",
        hardware_model="n228sap",
        board_id=0x1C,
        chip_id=0x8310,
        display_name="Apple Watch Series 11 (42mm Cellular)",
    ),
    IRecvDevice(
        product_type="Watch7,20",
        hardware_model="n228bap",
        board_id=0x1E,
        chip_id=0x8310,
    ...
    IRecvDevice(
        ...
        hardware_model="j274ap",
        board_id=0x22,
        chip_id=0x8103,
        display_name="Mac mini (M1, 2020)",
    ),
    IRecvDevice(
        product_type="MacBookPro17,1",
        hardware_model="j293ap",
        board_id=0x24,
        chip_id=0x8103,
        display_name="MacBook Pro (M1, 13-inch, 2020)",
    ),
    IRecvDevice(
        product_type="MacBookPro18,1",
        hardware_model="j316sap",
        board_id=0x0A,
        chip_id=0x6000,
        display_name="MacBook Pro (M1 Pro, 16-inch, 2021)",
    ),
    IRecvDevice(
        product_type="MacBookPro18,2",
        hardware_model="j316cap",
        board_id=0x0A,
        chip_id=0x6001,
        display_name="MacBook Pro (M1 Max, 16-inch, 2021)",
    ),
    IRecvDevice(
        product_type="MacBookPro18,3",
        hardware_model="j314sap",
        board_id=0x08,
        chip_id=0x6000,
        display_name="MacBook Pro (M1 Pro, 14-inch, 2021)",
    ),
    IRecvDevice(
        product_type="MacBookPro18,4",
        hardware_model="j314cap",
        board_id=0x08,
        chip_id=0x6001,
    ...
    IRecvDevice(
        ...
        hardware_model="j313ap",
        board_id=0x26,
        chip_id=0x8103,
        display_name="MacBook Air (M1, 2020)",
    ),
    IRecvDevice(
        product_type="iMac21,1",
        hardware_model="j456ap",
        board_id=0x28,
        chip_id=0x8103,
        display_name="iMac 24-inch (M1, Two Ports, 2021)",
    ),
    IRecvDevice(
        product_type="iMac21,2",
        hardware_model="j457ap",
        board_id=0x2A,
        chip_id=0x8103,
        display_name="iMac 24-inch (M1, Four Ports, 2021)",
    ),
    IRecvDevice(
        product_type="Mac13,1",
        hardware_model="j375cap",
        board_id=0x04,
        chip_id=0x6001,
        display_name="Mac Studio (M1 Max, 2022)",
    ),
    IRecvDevice(
        product_type="Mac13,2",
        hardware_model="j375dap",
        board_id=0x0C,
        chip_id=0x6002,
        display_name="Mac Studio (M1 Ultra, 2022)",
    ),
    IRecvDevice(
        product_type="Mac14,2",
        hardware_model="j413ap",
        board_id=0x28,
        chip_id=0x8112,
    ...
    IRecvDevice(
        product_type="iBridge2,1",
        hardware_model="j137ap",
        board_id=0x0A,
        chip_id=0x8012,
        display_name="Apple T2 iMacPro1,1 (j137)",
    ),
    IRecvDevice(
        product_type="iBridge2,3",
        hardware_model="j680ap",
        board_id=0x0B,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro15,1 (j680)",
    ),
    IRecvDevice(
        product_type="iBridge2,4",
        hardware_model="j132ap",
        board_id=0x0C,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro15,2 (j132)",
    ),
    IRecvDevice(
        product_type="iBridge2,5",
        hardware_model="j174ap",
        board_id=0x0E,
        chip_id=0x8012,
        display_name="Apple T2 Macmini8,1 (j174)",
    ),
    IRecvDevice(
        product_type="iBridge2,6",
        hardware_model="j160ap",
        board_id=0x0F,
        chip_id=0x8012,
        display_name="Apple T2 MacPro7,1 (j160)",
    ),
    IRecvDevice(
        product_type="iBridge2,7",
        hardware_model="j780ap",
        board_id=0x07,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro15,3 (j780)",
    ),
    IRecvDevice(
        product_type="iBridge2,8",
        hardware_model="j140kap",
        board_id=0x17,
        chip_id=0x8012,
        display_name="Apple T2 MacBookAir8,1 (j140k)",
    ),
    IRecvDevice(
        product_type="iBridge2,10",
        hardware_model="j213ap",
        board_id=0x18,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro15,4 (j213)",
    ),
    IRecvDevice(
        product_type="iBridge2,12",
        hardware_model="j140aap",
        board_id=0x37,
        chip_id=0x8012,
        display_name="Apple T2 MacBookAir8,2 (j140a)",
    ),
    IRecvDevice(
        product_type="iBridge2,14",
        hardware_model="j152fap",
        board_id=0x3A,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro16,1 (j152f)",
    ),
    IRecvDevice(
        product_type="iBridge2,15",
        hardware_model="j230kap",
        board_id=0x3F,
        chip_id=0x8012,
        display_name="Apple T2 MacBookAir9,1 (j230k)",
    ),
    IRecvDevice(
        product_type="iBridge2,16",
        hardware_model="j214kap",
        board_id=0x3E,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro16,2 (j214k)",
    ),
    IRecvDevice(
        product_type="iBridge2,19",
        hardware_model="j185ap",
        board_id=0x22,
        chip_id=0x8012,
        display_name="Apple T2 iMac20,1 (j185)",
    ),
    IRecvDevice(
        product_type="iBridge2,20",
        hardware_model="j185fap",
        board_id=0x23,
        chip_id=0x8012,
        display_name="Apple T2 iMac20,2 (j185f)",
    ),
    IRecvDevice(
        product_type="iBridge2,21",
        hardware_model="j223ap",
        board_id=0x3B,
        chip_id=0x8012,
        display_name="Apple T2 MacBookPro16,3 (j223)",
    ),
    IRecvDevice(
        product_type="iBridge2,22",
        hardware_model="j215ap",
        board_id=0x38,
        chip_id=0x8012,
