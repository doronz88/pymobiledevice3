...
class AmfiService:
    ...
    def create_amfi_show_override_path_file(self) -> None:
    ...
    def enable_developer_mode(self, enable_post_restart: bool = True) -> None:
        """
    ...
    def enable_developer_mode_post_restart(self) -> None:
