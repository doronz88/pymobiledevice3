...
from pymobiledevice3.utils import run_async_compat, try_decode
...
class _SyncAsyncGenIterator:
    ...
    def __next__(self):
        try:
            return run_async_compat(self._agen.__anext__())
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        def sync_call(*args, **kwargs):
            ...
            if inspect.isasyncgen(result):
                return _SyncAsyncGenIterator(result)
            if inspect.isawaitable(result):
                return run_async_compat(result)
            return result
