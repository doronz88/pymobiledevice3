...
class SessionProtocol:
    def __init__(self, inspector, id_: str, app: str, page: int, method_prefix: str = 'Automation') -> None:
        """
    ...
    async def send_command(self, method: str, **kwargs: Any) -> int:
    ...
    async def get_response(self, wir_id: int) -> Any:
    ...
    async def send_receive(self, method: str, wait_for_response: bool = True, **kwargs: Any) -> int:
    ...
    async def wait_for_message(self, id_: str) -> Mapping:
        while id_ not in self.inspector.wir_message_results:
            await asyncio.sleep(0)
        return self.inspector.wir_message_results.pop(id_)

    def sync_send_receive(self, method: str, wait_for_response: bool = True, **kwargs: Any) -> Any:
