...
class SwitchTo:
    ...
    def frame(self, frame_reference: Union[int, WebElement, str]) -> None:
        """
        Switches focus to the specified frame, by index, name, or web element.
        :param frame_reference: The name of the window to switch to, an integer representing the index,or a web element that is an (i)frame to switch to.
        """
    ...
    def new_window(self, type_: str = '') -> None:
