...
class LockdownClient(object):
    ...
    def __init__(self, udid: str = None, client_name: str = DEFAULT_CLIENT_NAME, autopair: bool = True,
                 ...
                 pair_record: Mapping = None, pair_not_valid_before: datetime.datetime = None,
                 pair_not_valid_after: datetime.datetime = None, pairing_records_cache_folder: Path = HOMEFOLDER):
        """
        ...
        :param pair_not_valid_before: when pairing use certificate validity starting at this date
        :param pair_not_valid_after: when pairing use certificate validity ending at this date
        """
        ...
        self.pair_not_valid_before = pair_not_valid_before
        self.pair_not_valid_after = pair_not_valid_after
        # TODO: consider supporting a "no storage" option (pairing_records_cache_folder = None) when SSL backend
        #       supports in-memory files.
        #       https://github.com/doronz88/pymobiledevice3/issues/294#issuecomment-1184609286
    ...
    def pair(self, timeout: int = None):
        ...
        cert_pem, private_key_pem, device_certificate = ca_do_everything(self.device_public_key,
                                                                         not_valid_before=self.pair_not_valid_before,
                                                                         not_valid_after=self.pair_not_valid_after)
    ...
    def _write_storage_file(self, filename: Union[Path, str], data: bytes) -> str:
